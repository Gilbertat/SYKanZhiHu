...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, performActionFor shortcutItem:
        ...
        if shortcutItem.localizedTitle == "首页" {
            let home:SYHomeViewController = storyBoard.instantiateViewController(withIdentifier: "home") as! SYHomeViewController
            let navi:ScrollingNavigationController = ScrollingNavigationController(rootViewController: home)
            self.window?.rootViewController = navi
        } else {
            let ranking:SYRankingViewController = storyBoard.instantiateViewController(withIdentifier: "ranking") as! SYRankingViewController
